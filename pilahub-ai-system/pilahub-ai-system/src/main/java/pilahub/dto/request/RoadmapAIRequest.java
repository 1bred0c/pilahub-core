...
public record RoadmapAIRequest(
                ...
                @Schema(description = "Trainee's age", example = "25") @NotNull @Min(10) @Max(120) Integer age,

                @Schema(description = "Trainee's gender", example = "MALE") @NotNull Gender gender,

                @Schema(description = "Workout level", example = "INTERMEDIATE") @NotNull @JsonProperty("workoutLevel") WorkoutLevel workoutLevel,

                @Schema(description = "Workout frequency", example = "MODERATE") @NotNull @JsonProperty("workoutFrequency") WorkoutFrequency workoutFrequency,

                @Schema(description = "Training days of week", example = "[\"MONDAY\", \"WEDNESDAY\", \"FRIDAY\"]") @NotEmpty @JsonProperty("trainingDays") List<String> trainingDays,

                @Schema(description = "Duration in weeks", example = "12") @NotNull @Min(1) @Max(52) @JsonProperty("durationWeeks") Integer durationWeeks,
