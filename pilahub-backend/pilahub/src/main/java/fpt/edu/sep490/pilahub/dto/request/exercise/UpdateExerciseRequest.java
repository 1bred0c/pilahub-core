...
@Schema(description = "Request to update an exercise")
public record UpdateExerciseRequest(
                @Schema(description = "Exercise name", example = "Push-ups") @Size(max = 255, message = "Exercise name must not exceed 255 characters") String name,
