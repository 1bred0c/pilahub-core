...
@Schema(description = "Request to create a personal stage supplement")
public record CreatePersonalStageSupplementRequest(
        @Schema(description = "Personal stage ID", example = "123e4567-e89b-12d3-a456-426614174000", requiredMode = Schema.RequiredMode.REQUIRED)
