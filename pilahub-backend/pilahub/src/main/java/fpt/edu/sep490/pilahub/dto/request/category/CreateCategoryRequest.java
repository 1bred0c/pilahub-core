...
public record CreateCategoryRequest(
        ...
        @Schema(description = "Category name", example = "Pilates Equipment", requiredMode = Schema.RequiredMode.REQUIRED) @NotBlank(message = "Category name must not be blank") @Size(max = 255, message = "Category name must not exceed 255 characters") String name,
